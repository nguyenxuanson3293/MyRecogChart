...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMonthly.add(new BarChartMonthlyData("2016-1-1", 24));
        listMonthly.add(new BarChartMonthlyData("2016-2-1", 45));
        listMonthly.add(new BarChartMonthlyData("2016-3-1", 57));
        listMonthly.add(new BarChartMonthlyData("2016-4-1", 14));
        listMonthly.add(new BarChartMonthlyData("2016-5-1", 45));
        listMonthly.add(new BarChartMonthlyData("2016-6-1", 47));
        listMonthly.add(new BarChartMonthlyData("2016-7-1", 89));
        listMonthly.add(new BarChartMonthlyData("2016-8-1", 20));
        listMonthly.add(new BarChartMonthlyData("2016-9-1", 35));
        listMonthly.add(new BarChartMonthlyData("2016-10-1", 24));
        listMonthly.add(new BarChartMonthlyData("2016-11-1", 45));
        listMonthly.add(new BarChartMonthlyData("2016-12-1", 57));
        listMonthly.add(new BarChartMonthlyData("2017-1-1", 14));
        listMonthly.add(new BarChartMonthlyData("2017-2-1", 45));
        listMonthly.add(new BarChartMonthlyData("2017-3-1", 47));
        listMonthly.add(new BarChartMonthlyData("2017-4-1", 89));
        listMonthly.add(new BarChartMonthlyData("2017-5-1", 20));
        listMonthly.add(new BarChartMonthlyData("2017-6-1", 35));
